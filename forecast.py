...
# Обновлённая подготовка данных для классических моделей
...
# Обновлённая подготовка данных для LSTM
...
# Функция для обучения и оценки случайного леса
...
# Функция для обучения и оценки LSTM
